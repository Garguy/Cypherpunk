...
import com.gardner.cypherpunk.presentation.coin_detail.components.CoinTag
import com.gardner.cypherpunk.presentation.coin_detail.components.TeamListItem
        ...
        state.coin?.let { coin ->
            LazyColumn(modifier = Modifier.fillMaxSize(), contentPadding = PaddingValues(20.dp)) {
                item {
                    ...
                    Spacer(modifier = Modifier.height(15.dp))
                    Text(text = "Team Memebers", style = MaterialTheme.typography.h3)
                    Spacer(modifier = Modifier.height(15.dp))
                }
